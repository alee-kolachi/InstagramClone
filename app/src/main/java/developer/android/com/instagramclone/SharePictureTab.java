...
public class SharePictureTab extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgShare = view.findViewById(R.id.imgView);
            ...
            case R.id.btnShareImage:
                if(recievedImageBitmap != null) {
                    if (edtDescription.getText().toString().length()==0){
                        Toasty.error(getContext(),"Image Description needed!");
                    }
                    else {
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                if(e==null){
                                    Toasty.success(getContext(),"Image Uploaded Successfully",Toasty.LENGTH_SHORT).show();
                                }
                                else {
                                    Toasty.error(getContext(),"Error uploading file",Toasty.LENGTH_SHORT).show();
                                }
    ...
    private void getChoseImage() {
        //Toasty.success(getContext(),"Now we can access images",Toasty.LENGTH_SHORT).show();
